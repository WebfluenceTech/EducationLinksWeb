...
export default function DestinationPage() {
  ...
  if (!dest) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F7F9FC] text-center px-4">
        ...
        <h1 className="text-3xl font-bold text-[#0B2545] mb-2">Destination Not Found</h1>
        <p className="text-[#3E5879] mb-8">We couldn't find a destination matching "{countryName}".</p>
        <Link to="/#destinations" className="px-6 py-3 bg-[#1E6FD9] text-white rounded-xl font-semibold hover:bg-[#1657AD] transition-colors">
  ...
  return (
    <>
      ...
      {/* ── Quick stats strip ── */}
      <div className="bg-[#1E6FD9] text-white">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-wrap gap-8 items-center justify-between">
          ...
          <a
            href="#inquiry"
            className="shrink-0 px-6 py-2.5 bg-white text-[#1E6FD9] font-bold text-sm rounded-xl hover:bg-gray-100 transition-colors shadow"
          >
            Apply Now →
          </a>
        </div>
      ...
      <div className="bg-[#F7F9FC] py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-[#3E5879] mb-10 ml-12">
            {universities.length} universities ready to welcome you
          </p>

          {universities.length === 0 ? (
            <div className="text-center py-24 text-[#3E5879]">
