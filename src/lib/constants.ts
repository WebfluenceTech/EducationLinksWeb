...
export const DESTINATIONS = [
  { name: 'Ireland', flag: '\u{1F1EE}\u{1F1EA}', region: 'Europe', universities: 4 },
  { name: 'Finland', flag: '\u{1F1EB}\u{1F1EE}', region: 'Europe', universities: 8 },
  { name: 'Sweden', flag: '\u{1F1F8}\u{1F1EA}', region: 'Europe', universities: 6 },
  ...
  { name: 'North Cyprus', flag: '\u{1F1F9}\u{1F1F7}', region: 'Europe', universities: 3 },
  ...
  { name: 'UAE', flag: '\u{1F1E6}\u{1F1EA}', region: 'Middle East', universities: 2 },
  { name: 'Australia', flag: '\u{1F1E6}\u{1F1FA}', region: 'Oceania', universities: 3 },
];
...
export const FEATURED_UNIVERSITIES = [
  ...
  { name: 'Uppsala Universitet', domain: 'uu.se' },
  { name: 'University of Skövde', domain: 'his.se' },
];

export const PARTNER_UNIVERSITIES = [
  { name: 'University of Skövde', domain: 'his.se' },
  { name: 'Hamdard University', domain: 'hamdard.edu.pk' },
  { name: 'University West', domain: 'hv.se' },
  { name: 'Rochester Institute of Technology Dubai', domain: 'ritdubai.ae' },
  ...
  { name: 'National College of Ireland', domain: 'ncirl.ie' },
  { name: 'Cork University Business School', domain: 'ucc.ie' },
